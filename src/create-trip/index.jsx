...
function CreateTrip() {
    ...
    return (
        <div className='max-w-5xl mx-auto px-5 mt-10 sm:px-10 md:px-32 lg:px-56 xl:px-10'>
            <h2 className='font-bold text-3xl mt-24'>Tell us your travel preferences 🏕️🌴</h2>
